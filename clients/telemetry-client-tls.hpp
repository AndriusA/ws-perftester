...
public:
    ...
    {   
        ...
        m_client.set_tls_init_handler(bind(&telemetry_client::on_tls_init,this,::_1));
        ...
        m_client.set_socket_init_handler(bind(&telemetry_client::on_socket_init, this, ::_1, ::_2));
    }
